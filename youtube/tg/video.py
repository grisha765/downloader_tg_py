...
async def download_video_tg(app, url_id, quality, message, user_id, duration, download_path):
    ...
    if chat_id is not None and message_id is not None:
        ...
        file_name = await download_video(url_id, quality, progress_hook, download_path)
